...
test('base currency amounts are rounded to whole minor units', function ($amount, $rate, int $expected) {
    ...
    'exact half stored just below it' => [150, '1.13', 170],
    'another exact half below it' => [350, '1.13', 396],
    'negative exact half below it' => [-150, '1.13', -170],
    'exact half from the stored decimal rate' => [150, 1.13, 170],
