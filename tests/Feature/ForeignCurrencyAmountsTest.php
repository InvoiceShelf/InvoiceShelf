...
test('payment creation and editing round converted payment and remaining invoice balances', function () {
    ...
    $payment = [
        ...
        'invoice_id' => $invoice->id, 'amount' => 1066, 'exchange_rate' => '11.257191',
    ];
...
test('expenses round converted money on create update and duplicate', function () {
    ...
    $this->postJson('/api/v1/expenses/'.$expense->id.'/duplicate', ['expense_date' => '2026-09-23'])->assertSuccessful();
    expect((string) Expense::latest('id')->firstOrFail()->base_amount)->toBe('114');
});
