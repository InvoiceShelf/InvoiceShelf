...
import ChartPlaceholder from './InstallerChartPlaceholder.vue'
...
async function loadInstaller() {
  ...
  let response = await installerStore.fetchViewInstaller({
    id: route.params.id,
  })
...
async function onChangeYear(data) {
  ...
  let response = await installerStore.fetchViewInstaller(params)
