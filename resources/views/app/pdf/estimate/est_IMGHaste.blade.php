    ...
    <table width="100%">
        <tr>
            ...
            <td class="header-right company-details">
                ...
                <p class="company-add">+357.220 30110 </p>
            </td>
        </tr>
    </table>
</div>
...
<div class="total-display-container">
    <table width="330px" cellspacing="0px" style="margin-left:400px; margin-top: 10px" border="0" class="total-display-table @if(count($estimate->items) > 12) page-break @endif">
        <tr>
