...
<head>
    ...
    <style type="text/css">
        ...
        /* ===== ESTIMATE META (date / expiry date) ===== */
        .meta-section {
...
<body>
        ...
        <table class="header-table">
            <tr>
                <td class="header-brand">
                    ...
                    @elseif ($estimate->customer->company)
                ...
                <td class="header-title-cell">
                    <div class="header-title">@lang('pdf_estimate_label')</div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="meta-section">
        <table class="meta-table">
            <tr>
                <td class="meta-label">@lang('pdf_estimate_date'):</td>
                <td class="meta-value">{{ $estimate->formattedEstimateDate }}</td>
            </tr>
            <tr>
                <td class="meta-label">@lang('pdf_estimate_expire_date'):</td>
    ...
    {{-- ===== ESTIMATE NUMBER ===== --}}
    <div class="estimate-number-section">
        @lang('pdf_estimate_number'): <span class="estimate-number-value">{{ $estimate->estimate_number }}</span>
    </div>
