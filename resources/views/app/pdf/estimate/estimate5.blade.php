...
<head>
    <title>Estimate / Proforma invoice</title>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="header-right company-details">
                ...
                <p class="company-add">VAT: 10379350Z</p>
...
<div class="header-table table-border">
    <table width="100%" class="text-center" style="padding-left:30px; padding-right:30px;">
        ...
        <tbody>
        <tr>
            <td class="text-center" style="font-size:12px;">Estimate / Proforma invoice</td>
            <td class="text-center" style="font-size:12px;"></td>
            <td class="text-center" style="font-size:12px;">{!! str_replace('AP-','',$estimate->estimate_number) !!}</td>
...
<div class="header-table table-border">
    <table width="100%" style="padding-left:30px; padding-right:30px;">
        ...
        @endif
        @if(isset($estimate->customer->fields[0]->string_answer))
        <tr>
            <th>VAT / GST </th>
...
<div class="total-display-container">
    <table width="100%" cellspacing="0px" style="margin-left:400px; margin-top: 10px" border="0" class="total-display-table @if(count($estimate->items) > 12) page-break @endif">
        ...
        @if(isset($estimate->fields[0]->string_answer))
        <tr>
            ...
            <td class="no-border total-border-right items padd8" style="padding-right:10px; text-align: right; font-size:12px;  padding-top:10px; color: #5851DB;">
                ${{ number_format($estimate->fields[0]->string_answer,2) }}
            </td>
        </tr>
        @endif
...
@if ($estimate->paid_status != 'PAID')
    ...
    <div class="header-table table-border margin:0 auto;">
        <table width="600" cellspacing="0px" style="margin-left:100px; margin-top: 10px" border="0" class="table3">
            ...
            <tr>
                <th>REASON</th>
                <td>{!! str_replace('-','',$estimate->estimate_number) !!}</td>
            </tr>
            <tr>
            ...
            <tr>
                <th>PAY Online</th>
                <td><a href="https://paypal.me/eSolutionsSofthouse/{{ number_format($estimate->total / 100,2) }}" target="_blank">Click here</a></td>
            </tr>
            </tbody>
        </table>
    </div>
