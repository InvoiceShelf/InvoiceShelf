...
<head>
    <title>@lang('pdf_credit_note_label') - {{ $creditNote->credit_note_number }}</title>
...
<body>
            ...
            <tr>
                @if ($logo)
                    ...
                    <td class="header-section-left" style="padding-top:0px;">
                        <h1 class="header-logo"> {{ $creditNote->customer->company->name }} </h1>
                @endif
                @endif
                </td>
    ...
    <div class="content-wrapper">
        <div class="main-content">
            ...
            <div class="credit-note-details-container">
                <table width="100%">
                    <tr>
                        <td class="attribute-label">@lang('pdf_credit_note_date')</td>
                        <td class="attribute-value"> &nbsp;{{ $creditNote->formattedCreditNoteDate }}</td>
                    </tr>
                    <tr>
                        <td class="attribute-label">@lang('pdf_credit_note_number')</td>
                        <td class="attribute-value"> &nbsp;{{ $creditNote->credit_note_number }}</td>
                    </tr>
                    @if ($creditNote->invoice && $creditNote->invoice->invoice_number)
                        <tr>
                            <td class="attribute-label">@lang('pdf_invoice_label')</td>
                            <td class="attribute-value"> &nbsp;{{ $creditNote->invoice->invoice_number }}</td>
                        </tr>
                    @endif
                </table>
            </div>
    ...
    <div class="total-display-box">
        <p class="total-display-label">@lang('pdf_credit_note_amount_deducted_label')</p>
        <span class="amount">{!! format_money_pdf($creditNote->amount, $creditNote->customer->currency) !!}</span>
    </div>
    <div class="notes">
        @if ($notes)
