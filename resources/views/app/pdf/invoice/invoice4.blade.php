    ...
    <table width="100%">
	    ...
	    <td class="header-left">
            ...
            <td class="header-right company-details">
                ...
                <p class="company-add">+357.220-30-110</p>
            </td>
        </tr>
    </table>
</div>
...
<div class="header-table table-border">
    <table width="100%" class="text-center" style="padding-left:30px; padding-right:30px;">
        ...
        <tbody>
        <tr>
            <td class="text-center" style="font-size:12px;">Τιμολόγιο παροχής υπηρεσιών</td>
...
<div class="header-table table-border">
    <table width="100%" style="padding-left:30px; padding-right:30px;">
        ...
        <tr>
            ...
            <td>
				@php
					$vatID = $invoice->customer->fields[1]->string_answer ?? $invoice->customer->fields[0]->string_answer;
				@endphp
				{!! htmlspecialchars($vatID) !!}
			</td>
        </tr>
        @if($invoice->customer->billingAddress && $invoice->customer->billingAddress->phone)
            <tr>
                <th>Τηλέφωνο</th>
    ...
    <div class="header-table table-border margin:0 auto;">
        <table width="600" cellspacing="0px" style="margin-left:100px; margin-top: 10px" border="0" class="table3">
            ...
            <tr>
                ...
                <td><a href="https://paypal.me/eSolutionsSofthouse/{{ number_format($invoice->total / 100,2) }}" target="_blank">Κάντε κλικ εδώ</a></td>
            </tr>
            </tbody>
        </table>
    </div>
